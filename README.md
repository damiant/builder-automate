# Builder Factory — Agent-Native Workspace
...
builder-factory/
├── packages/
│   └── shared/               # @builder-factory/shared — optional shared code
...
the shared package (`@builder-factory/shared`).
...
depends on `@builder-factory/shared`. Edit only the routes you care about;
